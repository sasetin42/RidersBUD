...
const HomeScreen: React.FC = () => {
    ...
    }, [db, selectedSpecs, ratingFilter, availableNowFilter]);
            ...
            <div className="px-6">
                ...
                <div className="mb-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div className="relative">
                        <button onClick={() => setSpecFilterOpen(!specFilterOpen)} className="w-full px-4 py-2 bg-field border border-dark-gray rounded-lg text-white text-left flex justify-between items-center h-[42px]">
                    ...
                    <select
                        ...
                        className="w-full px-4 py-2 bg-field border border-dark-gray rounded-lg text-white focus:outline-none focus:ring-1 focus:ring-primary h-[42px]"
                    >
                        <option value={0}>All Ratings</option>
                        <option value={4}>4 ★ & Up</option>
                        <option value={3}>3 ★ & Up</option>
                    </select>
                    <div className="flex items-center bg-field rounded-lg px-4 h-[42px] border border-dark-gray col-span-1 sm:col-span-2">
                        <input 
