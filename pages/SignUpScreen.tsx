...
const SignUpScreen: React.FC = () => {
    const { registerWithCredentials, loginWithGoogle, loading: authLoading } = useAuth();
                ...
                {userType === 'customer' ? (
                     <form onSubmit={handleCustomerSignUp} noValidate className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <button onClick={handleSocialLogin} disabled={anyLoading} className="w-full flex items-center justify-center gap-2 bg-field text-white font-bold py-3 rounded-lg hover:bg-gray-700 transition duration-300 disabled:opacity-70">
