...
const SignUpScreen: React.FC = () => {
    ...
    return (
        <div className="relative flex flex-col items-center justify-center min-h-screen bg-secondary overflow-x-hidden p-4">
            ...
            <div className="relative w-full max-w-md bg-dark-gray/40 backdrop-blur-xl border border-white/10 p-8 rounded-3xl shadow-2xl animate-slideInUp my-8">
                ...
                {userType === 'customer' ? (
                    <form onSubmit={handleCustomerSignUp} noValidate className="space-y-4 animate-fadeIn">
                        <div className="space-y-1">
                            <input type="text" name="name" placeholder="Full Name" value={customerData.name} onChange={handleCustomerChange} className={`w-full px-4 py-3.5 bg-field/50 border rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:bg-field transition-all duration-200 ${customerErrors.name ? 'border-red-500 ring-red-500/20' : 'border-white/5 focus:border-primary/50 focus:ring-primary/20'}`} />
                            {customerErrors.name && <p className="text-red-400 text-xs ml-1">{customerErrors.name}</p>}
                        </div>
                        <div className="space-y-1">
                            <input type="email" name="email" placeholder="Email" value={customerData.email} onChange={handleCustomerChange} className={`w-full px-4 py-3.5 bg-field/50 border rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:bg-field transition-all duration-200 ${customerErrors.email ? 'border-red-500 ring-red-500/20' : 'border-white/5 focus:border-primary/50 focus:ring-primary/20'}`} />
                            {customerErrors.email && <p className="text-red-400 text-xs ml-1">{customerErrors.email}</p>}
                        </div>
                        <div className="space-y-1">
                            <input type="tel" name="phone" placeholder="Phone Number" value={customerData.phone} onChange={handleCustomerChange} className={`w-full px-4 py-3.5 bg-field/50 border rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:bg-field transition-all duration-200 ${customerErrors.phone ? 'border-red-500 ring-red-500/20' : 'border-white/5 focus:border-primary/50 focus:ring-primary/20'}`} />
                            {customerErrors.phone && <p className="text-red-400 text-xs ml-1">{customerErrors.phone}</p>}
                        </div>
                        <div className="space-y-1">
                            <input type="password" name="password" placeholder="Password" value={customerData.password} onChange={handleCustomerChange} className={`w-full px-4 py-3.5 bg-field/50 border rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:bg-field transition-all duration-200 ${customerErrors.password ? 'border-red-500 ring-red-500/20' : 'border-white/5 focus:border-primary/50 focus:ring-primary/20'}`} />
                            {customerErrors.password && <p className="text-red-400 text-xs ml-1">{customerErrors.password}</p>}
                        </div>
                        <div className="space-y-1">
                            <input type="password" name="confirmPassword" placeholder="Confirm Password" value={customerData.confirmPassword} onChange={handleCustomerChange} className={`w-full px-4 py-3.5 bg-field/50 border rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:bg-field transition-all duration-200 ${customerErrors.confirmPassword ? 'border-red-500 ring-red-500/20' : 'border-white/5 focus:border-primary/50 focus:ring-primary/20'}`} />
                    ...
                    <form onSubmit={handleMechanicSignUp} className="space-y-4 animate-fadeIn">
                        <input type="text" name="name" placeholder="Full Name" value={mechanicData.name} onChange={handleMechanicChange} className="w-full px-4 py-3.5 bg-field/50 border border-white/5 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary/50 focus:bg-field transition-all duration-200" required />
                        <input type="email" name="email" placeholder="Email Address" value={mechanicData.email} onChange={handleMechanicChange} className="w-full px-4 py-3.5 bg-field/50 border border-white/5 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary/50 focus:bg-field transition-all duration-200" required />
                        <input type="tel" name="phone" placeholder="Phone Number" value={mechanicData.phone} onChange={handleMechanicChange} className="w-full px-4 py-3.5 bg-field/50 border border-white/5 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary/50 focus:bg-field transition-all duration-200" required />
                        <input type="password" name="password" placeholder="Password" value={mechanicData.password} onChange={handleMechanicChange} className="w-full px-4 py-3.5 bg-field/50 border border-white/5 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary/50 focus:bg-field transition-all duration-200" required />
                        <textarea name="bio" placeholder="Short Bio (Tell customers about yourself)" value={mechanicData.bio} onChange={handleMechanicChange} rows={3} className="w-full px-4 py-3.5 bg-field/50 border border-white/5 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary/50 focus:bg-field transition-all duration-200" />
                        <input type="text" name="specializations" placeholder="Specializations (comma-separated, e.g., Brakes)" value={mechanicData.specializations} onChange={handleMechanicChange} className="w-full px-4 py-3.5 bg-field/50 border border-white/5 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary/50 focus:bg-field transition-all duration-200" />
